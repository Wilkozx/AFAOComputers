...
<body>
    <form id="form1" runat="server">
        <div style="height: 617px">
            ...
            <asp:Button ID="btnLogin" runat="server" height="26px" OnClick="btnLogin_Click" style="z-index: 1; left: 165px; top: 245px; position: absolute" Text="Login" width="60px" />
            <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 253px; top: 245px; position: absolute" Text="Cancel" />
        </div>
    </form>
</body>
</html>
